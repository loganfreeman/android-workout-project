...
/**
 * Created by shanhong on 3/27/17.
 */

public class ListItemViewActivity extends AppCompatActivity implements ColorPickerDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.listitem_view_layout);
